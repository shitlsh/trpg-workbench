...
milestone_plan: .agents/plans/archive/m27-asset-ops-and-batch.md
---
...
**不**默认提供通用可变的 shell/CLI 工具；**采用**结构化工具补足 **移动 / 删除** 与 **批处理（含 preview）**，工程落地见 **[`.agents/plans/archive/m27-asset-ops-and-batch.md`](../../.agents/plans/archive/m27-asset-ops-and-batch.md)**。
...
**工程落地**：[M27 资产单步操作与批处理](../../.agents/plans/archive/m27-asset-ops-and-batch.md)（以仓库内该文件为准）。
