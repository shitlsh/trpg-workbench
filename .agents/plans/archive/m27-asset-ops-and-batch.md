...
- **file-first**：落盘、`.trpg/cache`、revision 与 [asset-schema-authoring](../../skills/asset-schema-authoring/SKILL.md) 一致。
...
- [ ] **A2.2**（可选，未实现，推迟至后续或需求驱动）：批量 slug 重命名或批量「同类型下移动」；**非** A 类必做。
