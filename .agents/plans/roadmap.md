...
| M31 | Chunk 类型系统重构 | ChunkType 精简为语义统一的 5 种+none，`_build_chunk_types_section()` 注入各 Agent 上下文，消除模型理解不对齐 | [m31-chunk-type-system.md](m31-chunk-type-system.md) |
